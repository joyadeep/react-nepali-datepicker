export class NepaliDateConverter {
    constructor() {
        this.bs_date_eq = "09/17/2000",
            this.ad_date_eq = "01/01/1944", this.bs = [],
            ...
            this.bs[2081] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31],
            this.bs[2082] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30],
            this.bs[2083] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30],
...
export function getBSMonths(e) {
    var t = getNepaliMonths();
    return e > 11 ? "Inavlid Month" : t[e];
}
